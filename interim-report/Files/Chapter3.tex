...
From inquiries around suppliers in the Kenyan Market, these bars are usually available in steel and aluminium. In order to select the optimum solution for this application, the Yield Strength, modulus of rigidity, Young's Modulus and density of both materials are considered. 
\begin{table}[!h]
...
\begin{tabular}{|l|l|}
\hline
\textbf{Input parameter} & \textbf{Value}\\
\hline
Force z-direction & 50N\\
\hline
Force y-direction & 0 N\\
\hline
Force x-direction & 0 N\\
\hline
Materials & Aluminium 6061\\
 & Stainless steel\\
\hline
Constraints & Fixed constraint of the base\\
\hline
Contacts & All bonded\\
\hline
...
\label{fig:rs485}
mmunication]{RS485 communication}
\end{figure}
\end{center}
...
\begin{center}
	...
	\caption[Control algorithm]{Control Algorithm for the Stewart Platform force balance}
         %equired electrical connections to make the system functional and interface with the control unit.
     \end{figure}
\end{center}
