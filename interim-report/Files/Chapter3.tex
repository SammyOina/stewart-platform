...
The Servo motor \textbf{TowerPro SG5010} used by the previous group is suitable for this project. The specifications provided by the manufacturer are as follows:
...
In the case of this project the use is of a full bridge strain gauge sensor with each strain gauge orthagonally positon allowing for elimination of noise and measurement of the strain axially on each rod.
