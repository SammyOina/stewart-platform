...
\begin{center}
	...
	\end{figure}
\end{center}
Assembling the Stewart platform legs as shown in \ref{fig} makes it easier to achieve the six degrees of freedom as opposed to having two legs on the attached on the same flange as in figure \ref{fig2}.
\begin{center}
\begin{figure}[!htb]
\centering
