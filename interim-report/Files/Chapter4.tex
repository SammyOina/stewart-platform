...
The user interface of the platform was programmed usig golang and this resulted in the view below with the use of sliders for platform positionning and buttons to set model orientationa and start data collection.
\begin{center}
	\begin{figure}[!h]
	\centering
