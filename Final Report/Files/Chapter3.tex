...
Both stainless steel and mild steel would make a suitable base for the Stewart platform due to their weight. They are also easy to machine (machinability for Mild steel - 78 per cent, for stainless steel: 45 - 110 per cent). Mild steel is readily available in the Kenyan market. Stainless steel is a bit more expensive. A comparison of these metal weights and machinability properties is shown in table \ref{table2}.
\begin{center}
\begin{table}[!h]
	\caption[Metal weight Properties]{Material weight properties}
	\label{table2}
\centering
\begin{tabular}{|l|l|l|}
\hline
\textbf{Metal} & \textbf{Density$(gcm^{-3})$} & \textbf{Machinability(percent)}\\
\hline
Aluminium (6061-T6)& 2.7 & 275\\
\hline
Mild Steel & 7.85 & 78\\
\hline
Stainless Steel & 7.5 - 8.0 & 45-110\\
\hline
\end{tabular}
\end{table}
\end{center}
