...
\subsection{Smoke Rake}
The smoke emitting device was 3D printed at iPIC and assembled and is shown in figure \ref{result}.
\begin{figure}[H]%
	\centering
	\subfloat[\centering 3D CAD View]{{\includegraphics[width=3cm]{Figures/Rake CAD} }}%
	\qquad
	\subfloat[\centering Final Rake ]{{\includegraphics[width=3cm]{Figures/smoke emitter}}}
	\caption[Smoke rake]{Final Smoke Rake}%
	\label{result}%
\end{figure}


%into the wind tunnel as shown in \ref{fig:smoke_res}.
