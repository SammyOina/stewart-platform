...
\subsection{Strut}
Computational Fluid Dynamics was done for various values of air spaid and the following drag forces were
...
\begin{table}[H]
	...
	\end{tabular}
\end{center}
Figure \ref{cfd} shows the effect of the strut to air flow as well as the amount of drag force expereienced.
\begin{center}
	\begin{figure}[H]
		\centering
...
The home position of the Stewart platform is when all servos are at 90 degree. Application of load on the platform
...
visualization of airflow around a model.