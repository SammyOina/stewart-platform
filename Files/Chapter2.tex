...
\begin{center}
	...
	\caption[A Typical Wind Tunnel]{Diagram of a typical wind tunnel}
	\end{figure}
\end{center}
...
\begin{figure}[!h]
	...
	\caption[NASA Wind Tunnels]{NASA wind tunnels used to test new airplane designs}
\end{figure}
\end{center}
...
\caption[NASA Wind tunnel - space application]{NASA wind tunnels used to test the design of heavy-lift rocket}
\end{figure}
\end{center}
...
\begin{center}
	...
	\caption[External Force balances]{Typical configurations for external force balances}
	\end{figure}
\end{center}
