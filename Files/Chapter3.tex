...
In this configuration the when the chip select of an amplifier is set to low, the microcontrller is able to obtain data from that strain gauge. This configuration allows for a four wire interface to connect to six strain gauge sensors and obtain measurements.
...
\begin{center}
	...
	\centering
	\includegraphics{Figures/Fig13}
	\caption[PID Controller]{Simple PID Low-level controller}
	\end{figure}
\end{center}
