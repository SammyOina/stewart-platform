...
The output excitation of the wheatstone brisge needs to be amplified as it results in low outputs. A analog to digital converter is also required for the strain gauge. Some considerable options are the hx711 or the AD7193 converters which may be used as digital to analog converters. The AD7193 is designed for high precision and has a delta sigma filter to remove noise from measurements. 
