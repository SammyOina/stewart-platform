...
\paragraph{}Wind tunnel testing is not cheap i.e. both to build and to use. While a crude wind tunnel can be constructed relatively cheaply from a large fan and
